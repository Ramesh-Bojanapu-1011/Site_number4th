      ...
      <div className="bg-white dark:bg-gray-900">
        ...
        <section className="max-w-5xl px-4 py-16 mx-auto md:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="p-6 text-center shadow bg-blue-50 dark:bg-gray-800 rounded-xl">
        ...
        <section className="max-w-6xl px-4 py-16 mx-auto md:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="p-6 text-center bg-white border border-gray-100 shadow dark:bg-gray-800 rounded-xl dark:border-gray-700">
              Web Development
        ...
        {/* Testimonials */}
        <section className="max-w-4xl px-4 py-16 mx-auto md:px-8">
          <h2 className="mb-10 text-3xl font-semibold text-center">
            What Our Users Say
          </h2>
